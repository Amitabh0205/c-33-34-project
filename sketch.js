...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("blue", "black");
  box2.display("blue", "black");
  box3.display("blue", "black");
  box4.display("blue", "black");
  box5.display("blued", "black");
  box6.display("indigo", "blackk");
  ...
  py6.display(rgb(251, 189, 76), "black")
  sling.display("balck");
  stand1.display();
  stand2.display();
  ball.display("darkblue", "balck");
}
